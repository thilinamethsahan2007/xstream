...
export default function Timeline({ content }: TimelineProps) {
    ...
    return (
        <div className="relative container mx-auto px-4 py-16">
            ...
            <div className="absolute left-4 md:left-1/2 top-32 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-white/20 to-transparent -translate-x-1/2 md:translate-x-0" />
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="absolute left-4 md:left-1/2 -translate-x-1/2 z-10 flex items-center justify-center">
                                ...
                                <div className="absolute w-6 h-6 bg-white/20 rounded-full animate-pulse" />
                            </div>
                            ...
                            <div className={`flex-1 w-full md:w-1/2 pl-12 md:pl-0 ${isEven ? 'md:pr-12' : 'md:pl-12'}`}>
                                <div
                                    className="group relative material-regular rounded-xl overflow-hidden hover:border-white/20 transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 cursor-pointer bg-white/5 backdrop-blur-md border border-white/5"
                                        ...
                                        <div className="flex-1 p-5 sm:p-6 flex flex-col justify-center relative overflow-hidden">
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex items-center gap-3 mb-2">
                                                    <span className="text-white text-lg font-bold font-mono tracking-tight">
                                                        {item.release_date ? new Date(item.release_date).getFullYear() : 'TBA'}
                                                    </span>
                                                    <span className="px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wider bg-white/10 text-white/70 border border-white/5">
                                                ...
                                                <h3 className="text-white font-bold text-xl sm:text-2xl mb-2 leading-tight tracking-tight transition-colors line-clamp-2">
                                                    {item.title}
                                                </h3>

                                                <p className="text-white/60 text-xs sm:text-sm line-clamp-2 leading-relaxed font-medium">
                                                    {item.overview}
                                                </p>
                                            </div>
                                        </div>
