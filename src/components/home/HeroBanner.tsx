                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        {isContentReleased(releaseDate) ? (
                            <button
                                ...
                                className="flex items-center justify-center gap-3 px-8 md:px-10 py-3.5 md:py-4 bg-white text-black rounded-full font-bold hover:bg-gray-200 transform hover:scale-105 active:scale-[0.97] text-lg shadow-xl"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-3 px-8 md:px-10 py-3.5 md:py-4 bg-white/20 text-white rounded-full font-bold hover:bg-white/30 transform hover:scale-105 active:scale-[0.97] text-lg backdrop-blur-md border border-white/10 shadow-lg"
                            style={{ transition: 'transform 160ms var(--ease-out), background-color 200ms var(--ease-out)' }}
                        >
                        ...
                        {trailerKey && isVideoLoaded && (
                            <button
                                ...
                                className="flex items-center justify-center gap-3 px-4 py-3.5 md:py-4 bg-white/10 text-white rounded-full font-bold hover:bg-white/20 transform hover:scale-105 active:scale-[0.97] backdrop-blur-md border border-white/10 shadow-lg"
                                style={{ transition: 'transform 160ms var(--ease-out), background-color 200ms var(--ease-out)' }}
                            >
