...
export default function MovieCard({ movie }: MovieCardProps) {
    ...
    return (
        ...
        >
            {/* Movie Poster */}
            {isTelegram ? (
                <div className="h-full w-full bg-[#1c1c1e] flex items-center justify-center p-4">
                    <span className="text-gray-400 font-semibold text-sm tracking-wide text-center line-clamp-4 leading-relaxed">{title}</span>
                </div>
            ) : !imageError ? (
                <img
                    src={posterUrl}
                ...
                {isTelegram ? (
                    <>
                        ...
                        <div className="flex items-center gap-2 text-xs mb-2 font-medium flex-wrap">
                            ...
                            <span className="border border-white/20 px-1.5 py-0.5 rounded text-[10px] uppercase text-gray-300 bg-white/10">
